package semester3.car.security.error;
...
public class CustomOAuth2AccessDeniedHandler implements AccessDeniedHandler {
  ...
  public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException e)
    ...
    //Refactor
    String wwwAuthenticate = semester3.car.security.error.CustomOAuth2AuthenticationEntryPoint.computeWWWAuthenticateHeaderValue(parameters);
